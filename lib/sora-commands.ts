...
export const COMANDOS: Comando[] = [
  ...
  },
  {
    ...
    descricao: 'Cria um compromisso pela conversa — a Sora entende dia e hora e te lembra. Você define a antecedência na própria frase: "me avisa 1 dia antes", "30 min antes" ou "na hora".',
    variantes: ['agendar reunião amanhã 9h me avisa 1 dia antes', 'marca consulta sexta 10h avisa 30 min antes'],
    categoria: 'sora-grow',
    feature: 'sora_grow',
  },
