...
export async function GET(req: NextRequest) {
  ...
  const BASE = 'id,name,email,phone,plano,plano_intervalo,plano_valido_ate,vitalicio,vitalicio_em,stripe_customer_id,onboarding_completed,welcomed_at,created_at';
