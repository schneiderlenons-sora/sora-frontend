...
// Trava o /quiz no TEMA CLARO, independente do tema escolhido no forsora.com
...
// quando o site estava no tema black. Aqui removemos .dark enquanto o /quiz está
...
export default function ForceLightTheme() {
  useEffect(() => {
    ...
    return () => {
      obs.disconnect();
      // Ao sair do /quiz, restaura o tema salvo (black -> .dark) pra não deixar o
