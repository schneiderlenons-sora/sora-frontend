...
const MARCAS: Record<string, Marca> = {
  ...
  vercel:            { si: 'vercel' },
  google:            { si: 'google' },
  'google ads':      { si: 'googleads',        domain: 'ads.google.com' },
  'google adwords':  { si: 'googleads' },
  ...
  rappi:             { si: 'rappi',            domain: 'rappi.com.br' },
  aiqfome:           { domain: 'aiqfome.com.br' },
  'aiq fome':        { domain: 'aiqfome.com.br' },
  'ze delivery':     { domain: 'zedelivery.com.br' },
  zedelivery:        { domain: 'zedelivery.com.br' },
  'zé delivery':     { domain: 'zedelivery.com.br' },
  blablacar:         { si: 'blablacar',        domain: 'blablacar.com.br' },
  'bla bla car':     { si: 'blablacar',        domain: 'blablacar.com.br' },
