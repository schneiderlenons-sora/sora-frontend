...
// ─────────────────────────────────────────────────────────────────────────────
// Sora /quiz — cópia do funil /chat com a oferta trocada: assinatura Premium
// R$ 29,90/mês (em vez do vitalício). Fundo branco + verde da marca (#61CE70).
// Cada etapa avança por clique; a simulação de chat revela mensagens com typing +
// slide-up. CTA final → /signup?plano=premium (Stripe). Mobile-first, acessível.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2 px-2">
        ...
        <p className="text-[15px] font-bold" style={{ color: HEAD }}>
          Mas o que a gente quer é a sua <span style={{ color: ACCENT }}>liberdade financeira</span>. Então liberamos por menos de <b>R$ 1 por dia</b> — sem fidelidade.
        </p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl p-6 text-white shadow-2xl"
        ...
        <div className="relative">
          ...
          <button onClick={assinar}
            ...
            <Lock size={17} /> Assinar o Premium agora
          </button>
