    ...
    <section className="relative overflow-hidden pt-10 lg:pt-20 pb-20 lg:pb-32">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="relative">
          ...
          {/* Headline */}
          <h1 className="mt-6 text-[44px] sm:text-[58px] lg:text-[68px] font-bold leading-[0.98] tracking-[-0.03em] animate-[slide-up_700ms_ease-out_both]" style={{ animationDelay: '80ms' }}>
            Sua vida inteira{' '}
          ...
          {/* Subhead */}
          <p className="mt-6 text-lg lg:text-xl text-zinc-600 dark:text-white/70 leading-relaxed max-w-xl animate-[slide-up_800ms_ease-out_both]" style={{ animationDelay: '160ms' }}>
          ...
          {/* CTAs */}
          <div className="mt-8 flex flex-wrap items-center gap-3 animate-[slide-up_900ms_ease-out_both]" style={{ animationDelay: '240ms' }}>
          ...
          {/* Trust bar */}
          <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-2 text-[12px] text-zinc-500 dark:text-white/50 animate-[slide-up_1000ms_ease-out_both]" style={{ animationDelay: '320ms' }}>
            ...
            <span className="inline-flex items-center gap-1.5"><Check size={12} /> 7 dias grátis</span>
          </div>
        </div>

        {/* ── COLUNA MOCKUPS ───────────────────────────────────── */}
        <div className="relative h-[540px] sm:h-[640px] lg:h-[680px] flex items-center justify-center">

          {/* Phone 1 — WhatsApp (back, rotated) */}
          <div className="absolute left-[5%] sm:left-[10%] top-[6%] w-[58%] sm:w-[52%] max-w-[280px] animate-[slide-up_900ms_ease-out_both] z-10"
          ...
          <div className="absolute right-[2%] sm:right-[6%] bottom-[2%] w-[62%] sm:w-[56%] max-w-[310px] animate-[slide-up_1100ms_ease-out_both] z-20"
          ...
          <FloatingChip className="top-[8%] right-[2%] hidden sm:flex" delay="600ms">
            <span style={{ color: BRAND }}>↑</span> R$ 3.450 saldo
          </FloatingChip>
          <FloatingChip className="bottom-[14%] left-[0%] hidden sm:flex" delay="900ms">
            🔥 12 dias de hábito
          </FloatingChip>
          <FloatingChip className="top-[40%] left-[-4%] hidden md:flex" delay="1100ms" variant="accent">
...
function FloatingChip({
  ...
  return (
    <div
      className={`absolute inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded-full shadow-lg backdrop-blur-md whitespace-nowrap animate-[slide-up_1000ms_ease-out_both,float-slow_5s_ease-in-out_infinite] ${
        variant === 'accent'
