...
import { Check, CheckCheck, BadgeCheck, Plus, Smile, Mic, type LucideIcon } from 'lucide-react';

const BRAND = '#61ce70'; // avatar/selo da Sora — sempre verde (identidade da marca)
