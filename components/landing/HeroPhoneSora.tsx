  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 flex flex-col"
      ...
      <div className="px-3 pt-2 pb-3 flex items-center justify-between">
        <div>
          <p className="text-[8px] text-zinc-500 dark:text-white/50 uppercase tracking-wider font-bold">{t('bomDia')}</p>
          <p className="text-[11px] font-bold text-zinc-950 dark:text-white">{t('nome')}</p>
        </div>
      ...
      <div className="flex-1 px-3 space-y-2 overflow-hidden">
        ...
        <div className="relative rounded-xl p-3 overflow-hidden text-white"
          ...
          <p className="text-[8px] uppercase tracking-wider opacity-60 font-bold mb-1">{t('saldoDisponivel')}</p>
          <p className="text-[18px] font-bold tabular-nums leading-none">{t('saldoValor')}</p>
          <div className="flex items-center justify-between mt-2 text-[8px]">
            ...
            <span className="opacity-50">{t('vsMesAnterior')}</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-1.5">
          <div className="rounded-lg p-2 bg-white dark:bg-white/[0.04] border border-zinc-200 dark:border-white/[0.06]">
            <p className="text-[7px] uppercase tracking-wider text-zinc-500 dark:text-white/50 font-bold">{t('habitos')}</p>
          ...
          <div className="rounded-lg p-2 bg-white dark:bg-white/[0.04] border border-zinc-200 dark:border-white/[0.06]">
            <p className="text-[7px] uppercase tracking-wider text-zinc-500 dark:text-white/50 font-bold">{t('metaViagem')}</p>
        ...
        <div className="rounded-lg p-2 bg-white dark:bg-white/[0.04] border border-zinc-200 dark:border-white/[0.06]">
          <div className="flex items-center justify-between mb-1.5">
            <p className="text-[8px] uppercase tracking-wider text-zinc-500 dark:text-white/50 font-bold">{t('ultimas')}</p>
            <span className="text-[7px] text-zinc-400">{t('verTudo')}</span>
          </div>
          <div className="space-y-1.5">
            <Transacao emoji="🛒" titulo={t('tx1Titulo')} valor={t('tx1Valor')} />
            <Transacao emoji="🏃" titulo={t('tx2Titulo')} valor={t('tx2Valor')} verde />
            <Transacao emoji="💊" titulo={t('tx3Titulo')} valor={t('tx3Valor')} verde />
            <Transacao emoji="📚" titulo={t('tx4Titulo')} valor={t('tx4Valor')} />
          </div>
        </div>
